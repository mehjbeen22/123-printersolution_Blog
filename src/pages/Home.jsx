...
const Home = () => {
  return (
    <div className="md:mt-0 mt-40">
      <div className="relative bg-[#0c4a6e] 700 py-40">
        <div
      ...
      {/* <section className="bg-white py-10">
        ...
        <div className="flex justify-center gap-8">
          <div className="text-center">
            <div className="bg-[#0c4a6e] rounded-full w-24 h-24 flex items-center justify-center text-white text-4xl mx-auto mb-4">
