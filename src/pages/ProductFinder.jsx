...
const ProductFinder = () => {
  ...
  return (
    <div>
      <div className="p-6">
        {/* Welcome Section */}
        <div className="flex justify-between items-center border-b border-[#0c4a6e] p-3">
        ...
        <section className="flex p-8 gap-10 border-b border-[#0c4a6e]">
          <div className="mb-8 pt-10 w-[50%]">
            ...
            <div className="mt-4 flex gap-3">
              ...
              {canRedirect && (
                <Link
                  to="/downloadDrivers"
                  className="px-2 py-1 bg-[#0c4a6e] text-white"
                >
                  NEXT
                </Link>
              )}
