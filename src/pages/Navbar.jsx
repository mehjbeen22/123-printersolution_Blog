  ...
  return (
    <nav className="bg-white fixed w-full top-0 z-10 shadow-md">
      {/* <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between py-4">
        ...
        <Link to="/">
          <img
            src="https://cdn.freebiesupply.com/images/large/2x/hewlett-packard-logo-[#0c4a6e]-and-white.png"
            alt="Logo"
        ...
        <div className="flex space-x-8 text-lg text-gray-700">
          <p className="hover:text-[#0c4a6e] transition duration-300">Explore</p>
          <p className="hover:text-[#0c4a6e] transition duration-300">Shop</p>
          <p className="hover:text-[#0c4a6e] transition duration-300">Support</p>
        </div>
      </div> */}

      {/* Navigation Links */}
      <ul
        className="flex flex-col sm:flex-row sm:space-x-8 bg-[#0c4a6e]
