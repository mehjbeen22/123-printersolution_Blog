const PrinterOffline = () => {
  return (
    <main className="flex justify-center items-center p-5 mt-20 text-[#075985]">
...
//           <h2 className="text-3xl font-bold mb-4 text-[#0c4a6e] ">
//             Printer Offline
//           </h2>
...
//             <h3 className="text-2xl font-bold mb-4 text-[#0c4a6e]">HP Smart</h3>
