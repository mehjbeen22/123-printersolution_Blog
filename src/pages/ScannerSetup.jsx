const ScannerSetup = () => {
  return (
    <main className="container mx-auto p-8 text-[#075985]">
...
const setupMethods = [
  {
    ...
    desc: [
      ...
      "Pick a color scheme for your document. Select between Color or [#0c4a6e] & White from the 'Color format' drop-down box. It’s also possible that your scanner may have different color options.",
...

  {
    ...
    desc: [
      ...
      "Decide on a color scheme. Select a color option from the 'Kind' drop-down box at the top of the page (e.g., [#0c4a6e] and White).",
